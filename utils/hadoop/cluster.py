...
from utils.hadoop import conf
from utils.hadoop.fs import webhdfs, LocalSubFileSystem
from utils.hadoop.job_tracker import LiveJobTracker

from utils.lib.paths import get_build_dir
...
def get_next_ha_yarncluster():
  ...
  """
  from utils.hadoop.yarn import mapreduce_api
  from utils.hadoop.yarn import resource_manager_api
  from utils.hadoop.yarn.resource_manager_api import ResourceManagerApi
  global MR_NAME_CACHE
